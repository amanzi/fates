#include "dtypes.h"
!===================================================
! DO NOT EDIT THIS FILE, it was generated using ./cime/src/externals/genf90/genf90.pl
...
module ncdio_pio
  ...
  use fileutils      , only : getavu, relavu, iulog, masterproc, single_column
  use fileutils      , only : spval, ispval
  ...
  use pio            , only : pio_init, PIO_iotype_netcdf, PIO_rearr_subset
  !
  ! !PUBLIC TYPES:
  implicit none
...
!# 103 "./components/clm/src/main/ncdio_pio.F90.in"
  interface ncd_io 
...
!  private :: scam_field_offsets ! get offset to proper lat/lon gridcell for SCAM
  ...
  type(iosystem_desc_t), target :: pioIoSystem
...
!# 161 "./components/clm/src/main/ncdio_pio.F90.in"
contains

  !-----------------------------------------------------------------------
!# 164 "./components/clm/src/main/ncdio_pio.F90.in"
...
!    io_type       =  shr_pio_getiotype(inst_name)
    ...
    numAggregator = 0
    optBase       = 1
    io_type        = PIO_iotype_netcdf
    niotasks = ntasks

    call PIO_init(myRank,      & ! MPI rank
    ...
    PIO_subsystem => pioIoSystem

!# 177 "./components/clm/src/main/ncdio_pio.F90.in"
  end subroutine ncd_pio_init

  !-----------------------------------------------------------------------
!# 180 "./components/clm/src/main/ncdio_pio.F90.in"
...
! !# 202 "./components/clm/src/main/ncdio_pio.F90.in"
   end subroutine ncd_pio_openfile

  !-----------------------------------------------------------------------
!# 205 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 216 "./components/clm/src/main/ncdio_pio.F90.in"
  end subroutine ncd_pio_closefile

  !-----------------------------------------------------------------------
!# 219 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 266 "./components/clm/src/main/ncdio_pio.F90.in"
  end subroutine ncd_pio_createfile

  !-----------------------------------------------------------------------
!# 269 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 303 "./components/clm/src/main/ncdio_pio.F90.in"
  end subroutine check_var

  !-----------------------------------------------------------------------
!# 306 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 335 "./components/clm/src/main/ncdio_pio.F90.in"
  end subroutine check_att

  !-----------------------------------------------------------------------
!# 338 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 362 "./components/clm/src/main/ncdio_pio.F90.in"
  end subroutine check_dim

  !-----------------------------------------------------------------------
!# 365 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 379 "./components/clm/src/main/ncdio_pio.F90.in"
  end subroutine ncd_enddef

  !-----------------------------------------------------------------------
!# 382 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 410 "./components/clm/src/main/ncdio_pio.F90.in"
  end subroutine ncd_inqdid

!   !-----------------------------------------------------------------------
!# 413 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 434 "./components/clm/src/main/ncdio_pio.F90.in"
  end subroutine ncd_inqdlen

  !-----------------------------------------------------------------------
!# 437 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 453 "./components/clm/src/main/ncdio_pio.F90.in"
  end subroutine ncd_inqdname

  !-----------------------------------------------------------------------
!# 456 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 519 "./components/clm/src/main/ncdio_pio.F90.in"
  end subroutine ncd_inqfdims

  !-----------------------------------------------------------------------
!# 522 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 555 "./components/clm/src/main/ncdio_pio.F90.in"
  end subroutine ncd_inqvid

  !-----------------------------------------------------------------------
!# 558 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 575 "./components/clm/src/main/ncdio_pio.F90.in"
  end subroutine ncd_inqvdims

  !-----------------------------------------------------------------------
!# 578 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 596 "./components/clm/src/main/ncdio_pio.F90.in"
  end subroutine ncd_inqvname

  !-----------------------------------------------------------------------
!# 599 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 616 "./components/clm/src/main/ncdio_pio.F90.in"
  end subroutine ncd_inqvdids

  !-----------------------------------------------------------------------
!# 619 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 662 "./components/clm/src/main/ncdio_pio.F90.in"
  end subroutine ncd_inqvdlen_byDesc


  !-------------------------------------------------------------------------
!# 666 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 702 "./components/clm/src/main/ncdio_pio.F90.in"
 end subroutine ncd_inqvdlen_byName


 !-----------------------------------------------------------------------
!# 706 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 750 "./components/clm/src/main/ncdio_pio.F90.in"
 end subroutine ncd_inqvdname_byDesc

 !-----------------------------------------------------------------------

!# 754 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 792 "./components/clm/src/main/ncdio_pio.F90.in"
 end subroutine ncd_inqvdname_byName

  !-----------------------------------------------------------------------

!# 796 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 814 "./components/clm/src/main/ncdio_pio.F90.in"
  end subroutine ncd_putatt_int

  !-----------------------------------------------------------------------
!# 817 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 835 "./components/clm/src/main/ncdio_pio.F90.in"
  end subroutine ncd_putatt_char

  !-----------------------------------------------------------------------
!# 838 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 863 "./components/clm/src/main/ncdio_pio.F90.in"
  end subroutine ncd_putatt_real

  !-----------------------------------------------------------------------
!# 866 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 887 "./components/clm/src/main/ncdio_pio.F90.in"
  end subroutine ncd_getatt_char


  !-----------------------------------------------------------------------
!# 891 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 908 "./components/clm/src/main/ncdio_pio.F90.in"
  end subroutine ncd_defdim

!   !-----------------------------------------------------------------------
!# 911 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 1048 "./components/clm/src/main/ncdio_pio.F90.in"
  end subroutine ncd_defvar_bynf

  !-----------------------------------------------------------------------
!# 1051 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 1126 "./components/clm/src/main/ncdio_pio.F90.in"
  end subroutine ncd_defvar_bygrid

  !------------------------------------------------------------------------
!# 1129 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 1156 "./components/clm/src/main/ncdio_pio.F90.in"
  end subroutine ncd_io_char_var0_start_glob

  !------------------------------------------------------------------------
  !DIMS 0,1
!# 1160 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 1250 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 1250 "./components/clm/src/main/ncdio_pio.F90.in"
  ...
  !DIMS 0,1,2,3
  !TYPE int,double
!# 1255 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 1347 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 1347 "./components/clm/src/main/ncdio_pio.F90.in"
  ...
  !DIMS 0,1,2
  !TYPE text
!# 1352 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 1431 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 1436 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 1600 "./components/clm/src/main/ncdio_pio.F90.in"
...
! #endif
  ...
  subroutine ncd_io_1d_logical(varname, data, dim1name, flag, ncid, nt, readvar, cnvrtnan2fill)
    ...
    call shr_sys_abort(' ERROR: ncd_io_1d_logical is corrupted. Problem call pio_read_darray ')    
...
!# 1600 "./components/clm/src/main/ncdio_pio.F90.in"
  ...
  !TYPE int,double
!# 1605 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 1825 "./components/clm/src/main/ncdio_pio.F90.in"
...
! !# 1605 "./components/clm/src/main/ncdio_pio.F90.in"
  subroutine ncd_io_2d_double(varname, data, dim1name, lowerb2, upperb2, &
    ...
    if (flag == 'read') then
       ...
       if (present(switchdim)) then
!          call pio_write_darray(ncid, vardesc, iodesc_plus%iodesc, temp, status, fillval=spval)
          call pio_write_darray(ncid, vardesc, iodesc_plus%iodesc, temp, status)          
       else
!          call pio_write_darray(ncid, vardesc, iodesc_plus%iodesc, data, status, fillval=spval)
          call pio_write_darray(ncid, vardesc, iodesc_plus%iodesc, data, status)          
       end if
...
! !   !TYPE int,double
! ! # 1830 "./components/clm/src/main/ncdio_pio.F90.in"
...
!# 1947 "./components/clm/src/main/ncdio_pio.F90.in"
...
! # 1951 "./components/clm/src/main/ncdio_pio.F90.in"
...
! # 2001 "./components/clm/src/main/ncdio_pio.F90.in"
...
! # 2147 "./components/clm/src/main/ncdio_pio.F90.in"
!   end subroutine scam_field_offsets

!   !------------------------------------------------------------------------

! # 2151 "./components/clm/src/main/ncdio_pio.F90.in"
...
! # 2339 "./components/clm/src/main/ncdio_pio.F90.in"
