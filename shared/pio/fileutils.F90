...
! !REVISION HISTORY:
  ...
  integer , parameter, public ::  iulog = 10
  integer , parameter, public ::  masterproc = 1
  logical,  public :: single_column = .true.
  real, public, parameter ::  spval = 1.e+36          ! special value for real data
...
!
! !INTERFACE:
   subroutine getfil (iulog, masterproc, fulpath, locfn, iflag)
!
! !DESCRIPTION:
...
! !ARGUMENTS:
     ...
     integer,          intent(in)  :: iulog, masterproc
!
! !REVISION HISTORY:
! Created by Mariana Vertenstein
!
...
!
! !INTERFACE:
   subroutine opnfil (iulog, masterproc, locfn, iun, form)
!
! !DESCRIPTION:
